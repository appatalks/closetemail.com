...
def generate_kitten_image():
    ...
    response = requests.post(
        ...
        json={
            "model": "dall-e-3",
            "prompt": "Create an image of a cat or kittens that is creative and unique with a Autumn/Fall and Back-to-School theme. Choose a random art style, such as photo realistic, surrealism, realism, anime, 1970 cartoon, modern cartoon, watercolor, abstract, black and white or digital painting. Choose a random setting like fantasy worlds, cityscapes, steam punk, lush forests, outerspace or imaginative places. Let the kittens be doing anything from playing to resting, exploring, or interacting in surprising ways. Let's also give it a Autumn/Fall and Back-to-School Theme.",
            "n": 1,
            "size": "1024x1024"
        }
    )
