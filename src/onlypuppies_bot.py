...
def generate_puppy_image():
    ...
    prompt = (
        "Create an image of a dog or puppies that is creative and unique with a Summer Time theme with "
        ...
        "imaginative places. Let the puppies be doing anything from playing to resting, exploring, or "
